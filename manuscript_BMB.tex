...
% reviewer1:com3 \rev{The DFE depends on \percap testing intensity $\rho$, the rate of test return $\omega$, and the population size $N$.} 
The DFE is 
\begin{equation}
\label{dfe}
...
% reviewer1:com4 \rev{Using the expression for the effectiveness of control parameter $\Delta$ in eq.~\ref{eq:del4a}, gives}
\begin{align}
\label{eq:d_del_wis}
