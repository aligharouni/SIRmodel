...
\david{Details such as the fact that you used ggplot are not important to state in the main text.  On the other hand, there isn't a clear narrative here.  The reader should feel that a story is being told.}\ali{partially addressed?, feedback is welcomed}
