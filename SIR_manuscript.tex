...
\bmb{super-fussy, but: I don't think we should introduce explicit thinspaces everywhere; why not let
  ...
  that will just change the appropriate settings globally?}\ali{are we talking about \,? not sure about the package!}
where
\begin{align}
\label{eq:C12}
