...
primarily diagnostic (determining infection status for clinical purposes)\needref, or for control (determining  infection status in order to isolate cases that have been found by contact tracing)\needref, which we characterize as \emph{targeted} testing strategies.
