...
Numerical evaluation of the effectiveness of control ($\Delta$: eq.~\ref{eq:del4_theta}\david{wrong eq ref}\bmb{maybe fixed? check}), over a range of testing and isolation parameters. Parameter values (Table~\ref{tab:params}):
