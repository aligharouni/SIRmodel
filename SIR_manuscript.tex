...
The observed dynamics of the COVID-19 epidemic is dirven by the underlying processes including both epidemiological processes (infection, recovery, etc.) and testing processes (who gets tested and intensity). In addition to determining what is actually observed (case reports), testing processes can also feed back to affect the epidemiological dynamics through isolation and quarantine. Specifically, individuals who are in the process of testing may partially or fully self-isolate, and individuals who have tested positive are highly likely to self-isolate. We developed a model that incorporates mechanistic epidemic processes and testing to explore the effects of testing and isolation on the epidemic dynamics, and providing insights for the population-level epidemic control.

During COVID-19 epidemic, since isolation has applied to people including, but not limited to, those who have been tested, the epidemic dynamics will depend on who gets tested. That is, how tests are distributed across epidemiological compartments for a given testing intensity. Specifically, in the case where tests are randomly assigned within the population, the tests will be weighted equally across all compartments. Random testing is the simplest form of testing regime and might happen, for example, when disease surveillance is the purpose of testing. However, in the case where targeted testing is administered within the population, the testing will be more weighted towards the compartments with people who have higher probability of getting tested. Targeted testing might happen, for example, for different purposes including diagnosis and treatment, screening people for access to things like flights, surgery, long-term-care facilities, and for mitigation and control of the disease spread. Specifically, when the purpose is "diagnosis and treatment" or "mitigation and control of disease spread", the bias is skewed towards infectious individuals with even more weights for the diagnosis and treatment than the mitigation and control. Also, when people are tested for "screening", the bias is towards the group-specific characteristics \ali{better wording needed}. For example, people who are getting on flights may or will be more mobile than people awaiting for a surgery and are probably going to stay in a long-term care facility and consequently more isolated to begin with.  

Furthermore, test-specific sensitivities, intensity and sample-to-answer reporting time are some components of the testing processes that influence the epidemic dynamic. We model these components and explore the trade-offs between them in achieving the epidemic control objective.
