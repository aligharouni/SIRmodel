...
\end{align}
Note that to determine the sign pattern of $\pro \Delta$ given the quadratic form of it in Eq. \eqref{eq:dd2dr}, it is important to know the sign of the coefficients of the polynomial, $a$, $b$ and $c$. Since $D_1\geq 0$ and $D_2\geq 0$, $b\leq 0$ and $c\geq 0$. Sign of $a$ depends on the interplay between the involved parameters (\todo{still working on}).
