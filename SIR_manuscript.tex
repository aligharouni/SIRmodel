...
\begin{itemize}
\item should emphasize (at some appropriate point in text) that $\Delta$ is independent of $\beta$ (and hence of $\Rnum$ if we are thinking primarily of holding $\gamma$ constant and varying $\beta$) for the small-$\rho$ (Taylor-expansion) case, see eq. ...
...
\end{itemize}
\ali{:}
\cite{bergstrom2020frequency} modeled repeated random testing of isolated populations.
