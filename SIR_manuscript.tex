...
\end{itemize}
\ali{:}
Testing dynamics has been previously modeled in the context of epidemiology.
\cite{bergstrom2020frequency} modeled repeated random testing of isolated populations and provided some analytical results.
\citep{friston2021testing} model the effects of self-isolation on testing and tracking.  
 Comparing to these works, our modeling execise is novel. 
}
