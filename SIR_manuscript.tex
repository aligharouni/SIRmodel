...
\jd{I was asking you to clarify the MS -- you never explain when you switch to assuming that the false-positive rate is zero -- not explain to me in notes. This explanation here looks wrong, though (compare with \eqref{dfe}).}
...
\end{equation}
\jd{It's hard to any point to presenting this equation in the main text if A, B C are not also in the main text.}
