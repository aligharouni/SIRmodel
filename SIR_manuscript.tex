...
The potential advantage of a slow rate of test return on the dynamics of an epidemic is real, often neglected, and needs to be quantified. At the individual level, this advantage can manifest in the following sense: individuals awaiting their test results or who have tested positive may partially or fully self-isolate, thus reducing or eliminating their potential in the transmission process.

At the community-level (e.g., nursing homes, LTC facilities, etc.), fast test reporting may be more beneficial. It gives a rapid assessment of the situation, identifies hot spots, and may enable rapid contact-tracing.  
...
\fady{General thoughts on the abstract (take with a grain of salt): I think the abstract is eye-catching and interesting. I think leading in by highlighting potential advantages to a slow test return may be ``provocative" (which may not necessarily be bad, I'm not sure). I think the second paragraph in some sense undermines or clashes with the first paragraph, especially since we don't actually address these potential advantages in this model. Maybe one way to spin this around would be to lead in with a discussion of the advantages of a FAST test return (i.e., the second paragraph), and then say ``but situations where returning tests more rapidly is BAD have not been studied". I think that could have better harmony or coordination.}
...
Mathematical modelling of infectious disease outbreaks provides insights on how testing processes influence the epidemiological processes through isolation. Here, we develop a compartmental SIR-type model to study the potential effect of testing strategies, testing intensity, test sensitivity and specificity, test reporting time, and isolation on epidemic dynamics. 

In agreement with our intuition, targeted testing strategies (i.e., strategies that identify the most infectious cases) are always more effective than random testing at lowering $\Rnum$. This reinforces the benefit of contact tracing in slowing transmission since tracing contacts of positive cases increases the likelihood of identifying other positive cases. Another approach that may enhance targeting accuracy may be to use pre-testing selection criteria that must be met by individuals wishing to be tested (e.g., symptoms questionnaires). While such an approach may enhance targeting, it may carry significant downsides (e.g., lessening the surveillance breadth of testing), which must be judged against the benefits.
\david{you need to be clearer: you mean targeting individuals who have contacted people who were infected.  For example, here you could say something like ``While targeting the contacts of confirmed cases\dots''}\fady{I moved this comment below the paragraph (so David is referring to the previous paragraph) and tried to resolve it. What do you think?}

Less intuitively, our analysis suggests that there are cases where reporting test results more rapidly could increase, rather than decrease $\Rnum$. This can occur when individuals are much more cautious when awaiting a test result than when they believe they are not infected, and may not be robust to second-order effects of fast testing (such as better contact tracing).


We incorporated the compartment-specific relative testing weights, $W_S$, $W_I$ and $W_R$, to model random testing and \emph{targeted} testing strategies. In the case of targeted testing and for the simplicity and illustration purposes, we assumed that infected and recovered individuals are tested at three times the \percap rate of susceptible individuals (thus $W_I/W_S=3$ and $W_R=W_I$). Note that we have not specified a methodology to assign particular relative testing weights corresponding to a particular targeted testing scenario.\fady{I don't understand the previous sentence}
