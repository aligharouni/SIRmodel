...
Note that $\rho$ and $\omega$ have a similar mechanism in delaying people to get into $I\_c$, thus we would expect to see the non-trivial countervailing effect of these two parameters on $\Rnum$.
