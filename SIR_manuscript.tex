...
\end{align}
Further details of derivation of $\Rnum$ are provided in appendix sec.\,\ref{app:R0}. Further, we show the nontrivial-nonmonotonic effect of testing intensity on $\Rnum$ appendix (See Sec.\,\ref{app:rho}). It is notable that this non-monotonic effect also occures with the rate of test return $\omega$. We show this for the case when testing intesity is very small by using the Taylor approximation of $\Rnum$ at $\rho=0$. \ali{some of these are methods!}  
