...
We also carried out simulation to support the analytical results in Proposition \ref{prop1}.
...
When random testing regime is applied, $W_S=W_I=W_R$,
...
%%%%%%%%%%%%
[Fady: this subsection and the next belong to the Appendix since they are very detailed. Would you 
(i) clean up the writing, there are some repeated expressions that can be referenced, (ii) write a paragraph for each to reflect what the message/application is?]
