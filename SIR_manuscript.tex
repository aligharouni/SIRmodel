...
\end{align}
Further details of derivation of $\Rnum$ are provided in appendix, Sec.\,\ref{app:R0}. Further, we show the nontrivial and nonmonotonic effect of testing intensity on $\Rnum$ in appendix, Sec.\,\ref{app:rho}. It is notable that this non-monotonic effect also occures with the rate of test return $\omega$. We show this for the case when testing intesity is very small by using the Taylor approximation of $\Rnum$ at $\rho=0$.  
