...
\end{equation}
where the term $\beta/\gamma$ is the classical basic reproduction number for a simple SIR model \citep{keeling2011modeling}, and $0 < \Delta < 1$ is the proportional reduction \david{actually $1-\Delta$ is the proportional reduction} due to testing and isolation processes, calculated as 
\begin{equation}
  \label{eq:del4a}
