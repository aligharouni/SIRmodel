...
\end{align}
The scaled expression of $\Delta$, specifically $\Delta\,C$, in Eq.\,\eqref{eq:del4_theta} is linear in $\theta\_c$ with a positive coefficient given by 
$$(\gamma\,S\_u^*\,+\omega(1-\theta\_w\,S\_u^*))\omega\,p_I\,\hat F_I.$$
...
With a similar logic, the expression of $\Delta\,C$ derived from Eq.\,\eqref{eq:del4_theta} is a concave-down quadratic equation in $\theta\_w$, given by
\begin{equation}
...
\pder[\Delta]{\theta\_w}\,C\bigg\rvert_{\theta\_w=1} =&
(D_2-2D_1-\omega^2\,p_I\,\hat F_I\,\theta\_c)\,S\_n^*+\gamma\,\hat F_I(\omega+\gamma) \\
=& (\gamma(\omega+\gamma)+\gamma\omega^2+(1-\theta\_c)\omega^2\,p_I\,\hat F_I )\,S\_n^*
+\gamma(\omega+\gamma)\,\hat F_I\,(1-S\_n^*),
\end{align}
...
Note that $\rho$ and $\omega$ have a similar mechanism in delaying people to get into $I\_c$, thus we would expect to see the counter-vailing effect, which is not obvious, of these two parameters on $\Rnum$. 
