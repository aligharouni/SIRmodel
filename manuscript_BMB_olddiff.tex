...
%DIF DEL manuscript_BMB.tex.b16a28171.oldfile   Mon Feb 28 22:04:37 2022
%DIF ADD manuscript_BMB.tex                     Mon Feb 28 22:00:57 2022
...
%DIF >  reviewer1:com3 \rev{The DFE depends on \percap testing intensity $\rho$, the rate of test return $\omega$, and the population size $N$.} 
The DFE is 
\begin{equation}
\label{dfe}
...
%DIF >  reviewer2:com2 future work...
...
%DIF >  reviewer1:com4 \rev{Using the expression for the effectiveness of control parameter $\Delta$ in eq.~\ref{eq:del4a}, gives}
\begin{align}
\label{eq:d_del_wis}
