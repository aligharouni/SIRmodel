...
params <- c(N0=1000000, beta=0.5,gamma=1/3, omega=0.25, rho=0.01, 
             W_S=1/3, W_I=1/3, W_R=1/3, #weights
...
n_in <- 41 ## grid N within facets
 ...
 omega <- seq(0.011,1 , length.out=n_in) #note omega must be > rho, was 0.1
...
```{r contour_R0_2, message=FALSE,warning=FALSE }
 # specify the ranges
eta_t <- seq(0.001,0.5, length.out=n_out)  
