...
\res 1 We now talk more generally about cautious behavior of people waiting (and cite Muller and Muller 2021 on this topic) in our discussion. 
...
\res 2 This is a good point. We now discuss possible interactions between epidemiological status (as reflected in a more complex model) and testing in the Discussion as a possible future investigation.
% JD try to write text
...
% {search for reviewer2:com1 in the manuscript_BMB.tex} 
