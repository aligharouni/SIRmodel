...
\res 2
[not sure here!] 
Regarding the incorporation of an exposed class or asymptomatic and infectious compartment to the current model; 
...
[This can be added to the manuscript?]
The potential future work of this project include:
\begin{enumerate}
\item
